...
main(int argc, char *argv[])
{
  if (argc != 8)
  ...
  else
    {
      ...
      norOutput.writeInt(n * 2);
      invOutput.writeInt(n * 2);
      int write[n * 2];
      int found;
      int sourceId;
      int targetId;
                      ...
                      if (cTargetAlign[i] != 0)
                        {
                          ...
                          norOutput.writeIntArray(inSourceWord + sourceId - nm,
                              n);
                          norOutput.writeIntArray(targetWord + targetId - nm,
                              nm);
                          norOutput.writeIntArray(targetWord + targetId + 1, nm);
                      ...
                      if (cSourceAlign[i] != 0)
                        {
                          ...
                          invOutput.writeIntArray(inSourceWord + sourceId - nm,
                              nm);
                          invOutput.writeIntArray(inSourceWord + sourceId + 1,
                              nm);
                                  ...
                                  if (cTargetAlign[i - j] != 0)
                                    {
                                      ...
                                      norOutput.writeIntArray(
                                          targetWord + targetId + 1, nm);
                                      norOutput.writeInt(targetWord[targetId]);

                                      invOutput.writeIntArray(
                                          targetWord + targetId - nm, n);
                                      invOutput.writeIntArray(
                                          inSourceWord + sourceId - nm, n - 1);
