...
main(int argc, char *argv[])
{
  if (argc != 5)
    {
      cout
          << "shortlistModelFileName oShortlistModelFileName newOutputVocFileName outModelFileName"
          << endl;
      return 0;
    }
  else
    {
      ...
      char* newOutputVocFileName = argv[3];
      char* outModelFileName = argv[4];
      ioFile iofC;
      ...
      realTensor selectOWeight;
      realTensor selectNWeight;
      ...
      SoulVocab* newOutputVoc = new SoulVocab(newOutputVocFileName);
      oslModel->outputVoc = newOutputVoc;
      ioFile oIof;
