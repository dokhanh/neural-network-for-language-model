...
main(int argc, char *argv[])
{
  if (argc != 8)
  ...
  else
    {
      ...
      int oldOutputNetworkNumber = inModel->outputNetworkNumber;
      ...
      int oldMaxCodeWordLength = inModel->maxCodeWordLength;
      ...
      realTensor selectOutWeight;
      realTensor selectInWeight;
      ...
      inModel->dataSet = new NgramDataSet(inModel->ngramType, inModel->n,
          ...
          inModel->mapIUnk, inModel->mapOUnk, MODEL_NGRAM_NUMBER);
